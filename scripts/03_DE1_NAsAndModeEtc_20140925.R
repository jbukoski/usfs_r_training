...
mode(dat$parcela)  # parcel
mode(dat$altura)   # height
...
# Let's simulate what occasionally happens when reading from an excel file and rows of NAs are 
...
dat <- rbind(dat, c(1, NA, "CANELO", NA, 13.2, NA))
